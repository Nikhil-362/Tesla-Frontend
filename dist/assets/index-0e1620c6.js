...
`;function fn({title:e,description:t,bgimage:n,lb:r,rb:i}){return be(Ry,{bg:n,children:[P(Ya,{cascade:!0,duration:"3000",children:be(Ay,{children:[P("h1",{children:e}),P("p",{children:t})]})}),be(Dy,{children:[P(Ya,{cascade:!0,duration:"1000",children:be(Iy,{children:[P(kp,{children:r}),i&&P(Ly,{children:i})]})}),P(My,{src:"/images/down-arrow.svg"})]})]})}const Ry=He.div`
    text-align: center;
    width: 100vw;
    height: 100vh;
...
`;function jy(e){return P("div",{children:be(Fy,{children:[P(fn,{title:"Model 3",description:"Leasing starting at $349/mo",bgimage:"model-3.jpg",lb:"Custom Order",rb:"Demo Drive"}),P(fn,{title:"Model y",description:"Order Online for Touchless Delivery",bgimage:"model-y.jpg",lb:"Custom Order",rb:"Demo Drive"}),P(fn,{title:"Model S",description:"Order Online for Touchless Delivery",bgimage:"model-s.jpg",lb:"Custom Order",rb:"Existing Inventory"}),P(fn,{title:"Model X",description:"Schedule a Demo Drive",bgimage:"model-x.jpg",lb:"Custom Order",rb:"Existing Inventory"}),P(fn,{title:"Solar Panels",description:"Lowest Cost Solar Panels in America",bgimage:"solar-panel.jpg",lb:"Custom Order",rb:"Learn More"}),P(fn,{title:"Solar Roof",description:"Produce Clean Energy From your Roof",bgimage:"solar-roof.jpg",lb:"Custom Order",rb:"Learn More"}),P(fn,{title:"Accessories",bgimage:"accessories.jpg",lb:"Shop Now"})]})})}const Fy=He.div`
    height: 100vh;
`;function Uy(){return be(Uc,{children:[P(jy,{}),P(Ey,{})]})}Fl.createRoot(document.getElementById("root")).render(P(ir.StrictMode,{children:P(Uy,{})}));
